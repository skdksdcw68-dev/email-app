...
/// Everything that actually needs a person, opened from the single row on the
/// inbox. Kept off the home screen so the briefing stays one line rather than
/// reprinting the inbox above the inbox.
